...
- README release links: `v0.18.8`.
- docs/quickstart release links: `v0.18.8`.
- Local latest tag: `v0.18.8`.
- GitHub latest release observed via `gh release view`: `v0.18.8`.

Version decision for this iteration: keep `0.18.8` because this is post-release hardening at the same `0.x` capability level, not a new feature release.
...
- `npm run check:release`: passed for `0.18.8`.
