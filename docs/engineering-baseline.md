...
- README release links: `v0.18.7`.
- docs/quickstart release links: `v0.18.7`.
- Local latest tag: `v0.18.7`.
- GitHub latest release observed via `gh release view`: `v0.18.7`.

Version decision for this iteration: keep `0.18.7` because this is post-release hardening at the same `0.x` capability level, not a new feature release.
...
- `npm run check:release`: passed for `0.18.7`.
