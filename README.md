...
```bash
curl -fsSL https://github.com/wfg2513148/apexcn-cli/releases/download/v0.18.1/install-agent.sh | APEXCN_API_KEY='你的_API_KEY' APEXCN_CLI_INSTALL_AGENT_SKILLS=1 bash -s -- --yes
```

Windows PowerShell：

```powershell
$env:APEXCN_API_KEY="你的_API_KEY"; $env:APEXCN_CLI_YES="1"; $env:APEXCN_CLI_INSTALL_AGENT_SKILLS="1"; irm "https://github.com/wfg2513148/apexcn-cli/releases/download/v0.18.1/install-agent.ps1" | iex
```
...
```bash
curl -fsSL https://github.com/wfg2513148/apexcn-cli/releases/download/v0.18.1/install-agent.sh | APEXCN_API_KEY='你的_API_KEY' bash -s -- --yes
```

Windows PowerShell：

```powershell
$env:APEXCN_API_KEY="你的_API_KEY"; $env:APEXCN_CLI_YES="1"; irm "https://github.com/wfg2513148/apexcn-cli/releases/download/v0.18.1/install-agent.ps1" | iex
```
...
```text
https://github.com/wfg2513148/apexcn-cli/releases/download/v0.18.1/install-agent.sh
https://github.com/wfg2513148/apexcn-cli/releases/download/v0.18.1/install-agent.ps1
https://github.com/wfg2513148/apexcn-cli/releases/download/v0.18.1/apexcn-cli.tgz
https://github.com/wfg2513148/apexcn-cli/releases/download/v0.18.1/checksums.txt
https://github.com/wfg2513148/apexcn-cli/releases/download/v0.18.1/apexcn-cli.tgz.sha256
https://github.com/wfg2513148/apexcn-cli/releases/download/v0.18.1/install-agent.sh.sha256
https://github.com/wfg2513148/apexcn-cli/releases/download/v0.18.1/install-agent.ps1.sha256
```
