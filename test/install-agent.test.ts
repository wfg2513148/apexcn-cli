...
describe('agent one-click installer assets', () => {
  test('macOS/Linux installer supports agent-safe automation', () => {
    ...
    expect(script).toContain('https://github.com/wfg2513148/apexcn-cli/releases/download/v0.1.6/apexcn-cli.tgz');
...
`,
  ...
  test('quickstart exposes one-line AI agent installation as the primary path', () => {
    ...
    expect(doc).toContain('https://github.com/wfg2513148/apexcn-cli/releases/download/v0.1.6/install-agent.sh');
    expect(doc).toContain('https://github.com/wfg2513148/apexcn-cli/releases/download/v0.1.6/install-agent.ps1');
