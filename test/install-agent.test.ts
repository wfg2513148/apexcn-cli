...
describe('agent one-click installer assets', () => {
  test('macOS/Linux installer supports agent-safe automation', () => {
    ...
    expect(script).toContain('https://github.com/wfg2513148/apexcn-cli/releases/download/v14.0.0/apexcn-cli.tgz');
...
`,
  ...
  test('macOS/Linux installer can install the npm package tarball layout', () => {
    ...
    try {
      ...
      const archive = join(tempRoot, 'apexcn-cli-14.0.0.tgz');
  ...
  test('quickstart exposes one-line AI agent installation as the primary path', () => {
    ...
    expect(doc).toContain('https://github.com/wfg2513148/apexcn-cli/releases/download/v14.0.0/install-agent.sh');
    expect(doc).toContain('https://github.com/wfg2513148/apexcn-cli/releases/download/v14.0.0/install-agent.ps1');
