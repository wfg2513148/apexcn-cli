...
describe("release version check", () => {
  ...
  test("npm package contains only runtime and user-facing assets", () => {
    ...
    expect(files).toEqual(expect.arrayContaining([
      ...
      "package.json",
      "qualification/releases/1.1.0/public-surface-v1.json",
      "qualification/releases/1.1.0/qualification-contract-v1.json",
      "qualification/releases/1.1.0/tasks-v1.jsonl",
