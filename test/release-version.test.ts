...
describe("release version check", () => {
  ...
  test("npm package contains only runtime and user-facing assets", () => {
    ...
    expect(files).toEqual(expect.arrayContaining([
      ...
      "package.json",
      "qualification/releases/1.1.1/public-surface-v1.json",
      "qualification/releases/1.1.1/qualification-contract-v1.json",
      "qualification/releases/1.1.1/tasks-v1.jsonl",
  ...
  test("release artifact check builds installable GitHub assets", () => {
    ...
    try {
      ...
      expect(entries).toEqual(expect.arrayContaining([
        ...
        "package/qualification/releases/1.1.1/public-surface-v1.json",
        "package/qualification/releases/1.1.1/qualification-contract-v1.json",
        "package/qualification/releases/1.1.1/tasks-v1.jsonl",
