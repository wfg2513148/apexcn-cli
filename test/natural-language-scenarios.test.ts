...
const writePreviewScenarios: Scenario[] = [
  ...
  scenario("preview mark correct answer", "把话题 30549 的第 3 条回复标记为正确答案", "reply mark-answer", "preview", ["api-write"], "required", ["--if-version <version>", "--preview"]),
  scenario("preview unmark correct answer", "取消话题 30549 中回复 201480 的正确答案标记", "reply unmark-answer", "preview", ["api-write"], "required", ["--if-version <version>", "--preview"]),
  ...
  scenario("preview reply favorite add", "收藏回复 201480，先给我看预览", "favorite add", "preview", ["api-write"], "available", ["--target <type>", "--preview"]),
  scenario("preview reply favorite remove", "取消收藏回复 201480，先给我看预览", "favorite remove", "preview", ["api-write"], "available", ["--target <type>", "--preview"]),
...
function apiWritePreviewScenarios(): ExecutableNaturalLanguageScenario[] {
  return [
    ...
    writePreview("reply mark-answer", "标记正确答案前先预览请求。", ["node", "apexcn", "reply", "mark-answer", "30549", "201480", "--if-version", "2", "--preview", "--json"], "/api/v1/topics/30549/replies/201480/correct-answer"),
    writePreview("reply unmark-answer", "取消正确答案前先预览请求。", ["node", "apexcn", "reply", "unmark-answer", "30549", "201480", "--if-version", "2", "--preview", "--json"], "/api/v1/topics/30549/replies/201480/correct-answer"),
