...
export const COMMAND_DESCRIPTORS: CommandDescriptor[] = [
  ...
  descriptor("favorite.add", ["favorite", "add"], "Favorite a topic or preview favoriting a reply", "write", "api-write", "medium", true, "apexcn favorite add 1 --target reply --preview", true, true),
  descriptor("favorite.remove", ["favorite", "remove"], "Unfavorite a topic or preview unfavoriting a reply", "write", "api-write", "medium", true, "apexcn favorite remove 1 --target reply --preview", true, true),
  ...
  descriptor("me.dashboard", ["me", "dashboard"], "Show the current user's personal dashboard", "read", "api-read", "low", true, "apexcn me dashboard --json"),
  ...
  descriptor("me.search", ["me", "search"], "Search only within the current user's personal dashboard", "read", "api-read", "low", true, 'apexcn me search "APEX" --json'),
  ...
  descriptor("reply.delete", ["reply", "delete"], "Preview reply deletion and return a confirmation id", "write", "api-write", "destructive", true, "apexcn reply delete 2 --if-version 1 --preview", true, true),
  descriptor("reply.mark-answer", ["reply", "mark-answer"], "Preview marking a reply as a correct answer", "write", "api-write", "high", true, "apexcn reply mark-answer 1 2 --if-version 1 --preview", true, true),
  ...
  descriptor("topic.delete", ["topic", "delete"], "Preview topic deletion and return a confirmation id", "write", "api-write", "destructive", true, "apexcn topic delete 1 --if-version 1 --confirm-title 标题 --preview", true, true),
