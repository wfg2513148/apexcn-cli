...
export const COMMAND_DESCRIPTORS: CommandDescriptor[] = [
  ...
  descriptor("reply.create", ["reply", "create"], "Preview reply creation; execute via workflow", "write", "api-write", "high", true, "preview-only", "apexcn reply create 1 --content 回复 --preview", true, true),
  descriptor("reply.delete", ["reply", "delete"], "Preview reply deletion; execute via workflow", "write", "destructive", "destructive", true, "preview-only", "apexcn reply delete 2 --yes --force --preview", true, true),
  descriptor("reply.update", ["reply", "update"], "Preview reply update; execute via workflow", "write", "api-write", "high", true, "preview-only", "apexcn reply update 2 --content 更新 --preview", true, true),
  ...
  descriptor("topic.create", ["topic", "create"], "Preview topic creation; execute via workflow", "write", "api-write", "high", true, "preview-only", "apexcn topic create --category-id 1 --title 标题 --content 正文 --preview", true, true),
  descriptor("topic.delete", ["topic", "delete"], "Preview topic deletion; execute via workflow", "write", "destructive", "destructive", true, "preview-only", "apexcn topic delete 1 --yes --force --confirm-title 标题 --preview", true, true),
  ...
  descriptor("topic.update", ["topic", "update"], "Preview topic update; execute via workflow", "write", "api-write", "high", true, "preview-only", "apexcn topic update 1 --content 正文 --preview", true, true),
