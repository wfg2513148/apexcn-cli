...
function verifyArtifacts() {
  ...
  const requiredFiles = [
    ...
    `package/qualification/releases/${expectedVersion}/public-surface-v1.json`,
    `package/qualification/releases/${expectedVersion}/qualification-contract-v1.json`,
    `package/qualification/releases/${expectedVersion}/tasks-v1.jsonl`,
